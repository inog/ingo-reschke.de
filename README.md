...
* `FTP_SERVER`: Netcup FTPS Hostname (z. B. `hostingXXXXXX.a2e12.netcup.net` oder `ingo-reschke.de`)
* `FTP_USERNAME`: Netcup FTP-Benutzername (z. B. `hostingXXXXXX` oder angelegter FTP-Nutzer)
* `FTP_PASSWORD`: Das zugehörige FTP-Passwort
